...
int main() {
    ...
    shmkeyp = ftok("~/Desktop/Marios - CEID/Λειτουργικά Συστήματα/Project2/MerosA_QuestionA/(B)", 2);
    shmidp = shmget(shmkeyp, sizeof(int*), 0664 | IPC_CREAT);
    p = (int*)shmat(shmidp, NULL, 0);
    *p = 0;
